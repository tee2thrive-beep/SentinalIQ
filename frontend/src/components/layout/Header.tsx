...
import { Search, Activity, Bell, PlusCircle } from 'lucide-react';
  ...
  return (
    <>
      <header className="h-16 bg-[#090d16]/90 backdrop-blur border-b border-[#1f293d] px-6 flex items-center justify-between sticky top-0 z-30">
        ...
        <div className="flex items-center space-x-3">
          <button
            ...
            className="inline-flex items-center gap-1.5 px-3 py-1.5 bg-blue-600 hover:bg-blue-500 text-white rounded-lg text-xs font-mono font-bold transition-colors shadow-sm shadow-blue-950"
          >
      ...
      <AddAlertModal
        ...
        onAlertAdded={() => {
          // Refresh page or trigger router revalidation
